...
namespace LinqTutorials
{
    public static class LinqTasks
    {
        ...
        {
            Emp result = Emps.OrderByDescending(e => e.HireDate).First(e => e.Job == "Frontend programmer");
            return result;
        }
        ...
        {
            IEnumerable<Emp> result = Emps.Where(e =>e.Mgr !=null)
                .OrderBy(e=>e.Ename).ThenByDescending(e=>e.Salary).ToList();
            return result;
        }
